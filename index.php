...
<div >
    ...
    <div class="flex justify-center mb-6 space-x-2">
        ...
        <form id="signInForm" action="./routage.php?action=authentification" method="POST" class="space-y-4">
        ...
        <form id="signUpForm" action="./routage.php?action=inscription" method="POST" class="hidden space-y-4">
